...
public final class CAnimations {
	...
	public void getCurrentAnimation(Player player) {
		switch (player.getCurrentStateID()) {
		case CConstants.STANDING:
			player.setCurrentAnimation(new Animation(playerS, 250));
			break;
		case CConstants.WALKING_LEFT:
			player.setCurrentAnimation(new Animation(playerWL, 250));
			break;
		case CConstants.WALKING_RIGHT:
			player.setCurrentAnimation(new Animation(playerWR, 250));
			break;
		default:
			player.setCurrentAnimation(new Animation(playerS, 250));
			break;
